...
class SoundStreamInversion(torch.nn.Module):
    def __init__(
        ...
        self.out_conv: torch.nn.Conv1d = torch.nn.Conv1d(
            in_channels=out_channels * channel_multipliers[-1],
            out_channels=out_channels,
            kernel_size=3,
            stride=1,
        )
...
# MelGAN discriminator architecture 
# based on https://github.com/descriptinc/melgan-neurips/
